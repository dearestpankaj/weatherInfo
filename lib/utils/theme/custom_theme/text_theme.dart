...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    displayLarge: const TextStyle().copyWith(fontSize: 64.0, fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    displayLarge: const TextStyle().copyWith(fontSize: 64.0, fontWeight: FontWeight.bold, color: Colors.white),
